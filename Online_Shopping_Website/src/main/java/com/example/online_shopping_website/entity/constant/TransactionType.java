...
public class TransactionType {
    ...
    public static final int commissionToProfitAccount = 9;              //完成订单后，佣金转入商城利润账户
    public static final int profitToShopAccount = 10;                   //完成订单后，订单利润转入商店账户
    public static final int refundToPrivateAccount = 11;                //同意退款后，订单金额转回个人账户
