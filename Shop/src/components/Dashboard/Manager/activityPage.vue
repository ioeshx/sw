  ...
  <div>
    <form>
      <div class="input-group">
        <label for="receiverName">活动持续时间: </label>
        <input id="receiverName" type="text" v-model="editedAddress.receiverName" @blur="validateField('ActivityDuration')" />
      </div>
      <div class="input-group">
        <label for="phone">活动类别: </label>
        <input id="phone" type="text" v-model="editedAddress.phone" @blur="validateField('ActivityDuration')" />
      </div>
      <div class="input-group">
        <label for="province">活动资金: </label>
        <input id="province" type="text" v-model="editedAddress.province" @blur="validateField('province')" />
      </div>
      <div class="input-group">
        <label for="municipality">满: </label>
        <input id="municipality" type="text" v-model="editedAddress.municipality" @blur="validateField('municipality')" />
      </div>
      <div class="input-group">
        <label for="county">减: </label>
        <input id="county" type="text" v-model="editedAddress.county" @blur="validateField('municipality')"/>
      </div>
      <div class="input-group">
        <label for="township">注册资金要求: </label>
        <input id="township" type="text" v-model="editedAddress.township" @blur="validateField('municipality')"/>
      </div>
      <div class="input-group">
        <label for="detailAddress">月销量要求: </label>
        <input id="detailAddress" type="text" v-model="editedAddress.detailAddress" @blur="validateField('detailAddress')" />
      </div>
      <div class="input-group">
        <label for="detailAddress">月销售额要求: </label>
        <input id="detailAddress" type="text" v-model="editedAddress.detailAddress" @blur="validateField('detailAddress')" />
      </div>
    </form>
